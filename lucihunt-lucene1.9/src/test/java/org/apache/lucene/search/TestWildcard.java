...
public class TestWildcard extends TestCase {
    ...
    public void testQuestionmark() throws IOException {
        RAMDirectory indexStore = getIndexStore("body", new String[] { "metal", "metals", "mXtals", "mXtXls" });
        IndexSearcher searcher = new IndexSearcher(indexStore);
    ...
    private RAMDirectory getIndexStore(String field, String[] contents) throws IOException {
