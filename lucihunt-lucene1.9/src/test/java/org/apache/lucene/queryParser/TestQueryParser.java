...
public class TestQueryParser extends TestCase {
    ...
    public void assertQueryEquals(String query, Analyzer a, String result) throws Exception {
        ...
        if (!s.equals(result)) {
            ...
            System.out.println("Query /" + query + "/ yielded /" + s + "/, expecting /" + result + "/");
        }
    ...
    public void testInstance() {
        try {
            System.out.println(getQuery("a AND b", null) instanceof BooleanQuery);
            System.out.println(getQuery("hello", null) instanceof TermQuery);
            System.out.println(getQuery("term +stop", new StandardAnalyzer()) instanceof BooleanQuery);

            Query q = getQuery("\"hello there\" ~3", null);
            System.out.println(q.toString());
            if (q instanceof PhraseQuery) {
                PhraseQuery pq = ((PhraseQuery) q);
                Term[] tms = pq.getTerms();
                System.out.println(Joiner.on(",").join(tms));
                System.out.println(pq.getSlop());
            }
            //            System.out.println(getQuery("\"hello there \"", null) instanceof PhraseQuery);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void testSimple() throws Exception {
        ...
        System.out.println(getQuery("a AND b", null) instanceof TermQuery);
        System.out.println(getQuery("hello", null) instanceof TermQuery);
        System.out.println(getQuery("\"hello there\"", null) instanceof PhraseQuery);
    ...
    public void testDateRange() throws Exception {
        ...
        assertQueryEquals("[ " + startDate + " TO " + endDate + "]", null, "[" + getDate(startDate) + " TO " + DateField.dateToString(endDateExpected.getTime()) + "]");
    ...
    private static void addDateDoc(String content, int year, int month, int day, int hour, int minute, int second, IndexWriter iw) throws IOException {
