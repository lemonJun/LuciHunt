...
public class TestMultiAnalyzer extends TestCase {
    ...
    public void testMultiAnalyzerWithSubclassOfQueryParser() throws ParseException {
        ...
        assertEquals("\"foo bar\"~99", qp.getSuperFieldQuery("", "foo bar").toString());
        assertEquals("\"(multi multi2) bar\"~99", qp.getSuperFieldQuery("", "multi bar").toString());
    ...
    private final class TestFilter extends TokenFilter {
        ...
        public final org.apache.lucene.analysis.Token next() throws java.io.IOException {
            if (multiToken > 0) {
                org.apache.lucene.analysis.Token token = new org.apache.lucene.analysis.Token("multi" + (multiToken + 1), prevToken.startOffset(), prevToken.endOffset(), prevToken.type());
        ...
        public final org.apache.lucene.analysis.Token next() throws java.io.IOException {
            for (Token t = input.next(); t != null; t = input.next()) {
                if (t.termText().equals("the")) {
                    ...
                    org.apache.lucene.analysis.Token token = new org.apache.lucene.analysis.Token(t.termText(), t.startOffset(), t.endOffset(), t.type());
    ...
    private final static class DumbQueryParser extends QueryParser {
        ...
        public Query getSuperFieldQuery(String f, String t) throws ParseException {
            return super.getFieldQuery(f, t);
        }

        /** wrap super's version */
        protected Query getFieldQuery(String f, String t) throws ParseException {
