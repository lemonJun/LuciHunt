...
public class TestDoc extends TestCase {
    ...
    private void indexDoc(String segment, String fileName) throws Exception {
    ...
    private void merge(String seg1, String seg2, String merged, boolean useCompoundFile) throws Exception {
        Directory directory = FSDirectory.getDirectory(indexDir, false);
    ...
    private void printSegment(PrintWriter out, String segment) throws Exception {
        Directory directory = FSDirectory.getDirectory(indexDir, false);
