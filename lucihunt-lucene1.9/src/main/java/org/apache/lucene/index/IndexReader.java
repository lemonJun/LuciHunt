...
public abstract class IndexReader {
     ...
     * @see org.apache.lucene.document.Field.TermVector
     */
    abstract public TermFreqVector getTermFreqVector(int docNumber, String field) throws IOException;
    ...
    public TermDocs termDocs(Term term) throws IOException {
        ...
        System.out.println(JSON.toJSONString(termDocs));
        termDocs.seek(term);
        return termDocs;
    }
