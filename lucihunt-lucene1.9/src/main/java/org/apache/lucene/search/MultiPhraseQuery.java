...
public class MultiPhraseQuery extends Query {
    ...
    private class MultiPhraseWeight implements Weight {
        ...
        public Scorer scorer(IndexReader reader) throws IOException {
            ...
            if (slop == 0)
                return new ExactPhraseScorer(this, tps, getPositions(), similarity, reader.norms(field));
            else
                return new SloppyPhraseScorer(this, tps, getPositions(), similarity, slop, reader.norms(field));
        }
    ...
    public int hashCode() {
        return Float.floatToIntBits(getBoost()) ^ slop ^ termArrays.hashCode() ^ positions.hashCode() ^ 0x4AC65113;
    }
}
