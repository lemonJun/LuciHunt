...
/**
 * 找出Term对文档的重要性的过程称为计算词的权重
 * 要理解清楚可以看这个文章：http://www.cnblogs.com/forfuture1978/archive/2009/12/14/1623594.html
 * TF-IDF：计算Term的权重
 * VSM:向量空间模型，判断Term之间的关系，计算此值之前 需要先计算term对doc的重要性
 * 
 *  
