...
public class FastVectorHighlighterTest {
    ...
    public static void testBoostedPhraseHighlightTest() throws IOException {
        ...
        FieldQuery fieldQuery = highlighter.getFieldQuery(query, reader);
        String fragment = highlighter.getBestFragment(fieldQuery, reader, 0, "text", 10000);
    ...
    public static void testFormater() throws IOException, ParseException {
        ...
        type.setStoreTermVectors(true);
        type.freeze();
        Field field = new Field("field", "This is a test where foo is highlighed&<underline> and should be \"highlighted\".", type);
        ...
        String[] bestFragments = highlighter.getBestFragments(fieldQuery, reader, docId, "field", matchedFields, 100, 1, fragListBuilder, fragmentsBuilder, preTags, postTags, encoder);
        System.out.println(bestFragments[0]);
