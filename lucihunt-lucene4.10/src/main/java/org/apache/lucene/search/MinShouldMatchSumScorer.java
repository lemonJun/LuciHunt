...
class MinShouldMatchSumScorer extends Scorer {
    ...
    public long cost() {
        ...
        final float c1 = 1.0f, c2 = 1.0f; // maybe a constant, maybe a proportion between costCandidateGeneration and sum(subScorer_to_be_advanced.cost())?
        return (long) (c1 * costCandidateGeneration + // heap-merge cost
