    ...
    private class FieldsWriter extends DocValuesConsumer {
        ...
        private DocValuesConsumer getInstance(FieldInfo field) throws IOException {
            ...
            if (consumer == null) {
                ...
                final String segmentSuffix = getFullSegmentSuffix(segmentWriteState.segmentSuffix, getSuffix(formatName, Integer.toString(suffix)));
    ...
    private class FieldsReader extends DocValuesProducer {
        ...
        public long ramBytesUsed() {
            ...
            for (Map.Entry<String, DocValuesProducer> entry : formats.entrySet()) {
                size += (entry.getKey().length() * RamUsageEstimator.NUM_BYTES_CHAR) + entry.getValue().ramBytesUsed();
            }
            return size;
        }
