...
public final class CompressingStoredFieldsWriter extends StoredFieldsWriter {
    ...
    public void abort() {
        ...
        IOUtils.deleteFilesIgnoringExceptions(directory, IndexFileNames.segmentFileName(segment, segmentSuffix, FIELDS_EXTENSION), IndexFileNames.segmentFileName(segment, segmentSuffix, FIELDS_INDEX_EXTENSION));
    }
    ...
    public int merge(MergeState mergeState) throws IOException {
        ...
        for (AtomicReader reader : mergeState.readers) {
            ...
            if (matchingFieldsReader == null || matchingFieldsReader.getVersion() != VERSION_CURRENT // means reader version is not the same as the writer version
                            || matchingFieldsReader.getCompressionMode() != compressionMode || matchingFieldsReader.getChunkSize() != chunkSize) { // the way data is decompressed depends on the chunk size
                // naive merge...
