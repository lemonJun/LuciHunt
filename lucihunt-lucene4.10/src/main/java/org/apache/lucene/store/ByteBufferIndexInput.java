...
abstract class ByteBufferIndexInput extends IndexInput implements RandomAccessInput {
    ...
    protected ByteBufferIndexInput newCloneInstance(String newResourceDescription, ByteBuffer[] newBuffers, int offset, long length) {
        if (newBuffers.length == 1) {
            ...
            return (offset == 0) ? new DefaultImpl(newResourceDescription, newBuffers, length, chunkSizePower, cleaner, clones) : new WithOffsetImpl(newResourceDescription, newBuffers, offset, length, chunkSizePower, cleaner, clones);
        }
    }
    ...
    static final class DefaultImpl extends ByteBufferIndexInput {
        ...
        DefaultImpl(String resourceDescription, ByteBuffer[] buffers, long length, int chunkSizePower, BufferCleaner cleaner, WeakIdentityMap<ByteBufferIndexInput, Boolean> clones) {
    ...
    static final class WithOffsetImpl extends ByteBufferIndexInput {
        ...
        WithOffsetImpl(String resourceDescription, ByteBuffer[] buffers, int offset, long length, int chunkSizePower, BufferCleaner cleaner, WeakIdentityMap<ByteBufferIndexInput, Boolean> clones) {
            super(resourceDescription, buffers, length, chunkSizePower, cleaner, clones);
            this.offset = offset;
            try {
                seek(0L);
