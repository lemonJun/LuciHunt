...
public final class CompoundFileDirectory extends BaseDirectory {
    ...
    private final Map<String, FileEntry> readEntries(IndexInput handle, Directory dir, String name) throws IOException {
        ...
        try {
            ...
            if (firstInt == CODEC_MAGIC_BYTE1) {
                ...
                version = CodecUtil.checkHeaderNoMagic(stream, CompoundFileWriter.DATA_CODEC, CompoundFileWriter.VERSION_START, CompoundFileWriter.VERSION_CURRENT);
