...
class FrozenBufferedUpdates {
    ...
    public FrozenBufferedUpdates(BufferedUpdates deletes, boolean isSegmentPrivate) {
        ...
        bytesUsed = (int) (terms.ramBytesUsed() + queries.length * BYTES_PER_DEL_QUERY + numericUpdatesSize + RamUsageEstimator.shallowSizeOf(numericDVUpdates) + binaryUpdatesSize + RamUsageEstimator.shallowSizeOf(binaryDVUpdates));
