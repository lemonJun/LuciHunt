...
public final class FST<T> implements Accountable {
    ...
    */
    ...
    FST<T> pack(int minInCountDeref, int maxDerefNodes, float acceptableOverheadRatio) throws IOException {
        ...
        final GrowableWriter newNodeAddress = new GrowableWriter(PackedInts.bitsRequired(this.bytes.getPosition()), (int) (1 + nodeCount), acceptableOverheadRatio);
        ...
        while (true) {
            ...
            for (int node = (int) nodeCount; node >= 1; node--) {
                ...
                writeNode: while (true) { // retry writing this node
