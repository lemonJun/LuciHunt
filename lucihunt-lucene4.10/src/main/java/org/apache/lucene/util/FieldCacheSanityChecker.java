...
public final class FieldCacheSanityChecker {
     ...
     */
    private Collection<Insanity> checkValueMismatch(MapOfSets<Integer, CacheEntry> valIdToItems, MapOfSets<ReaderField, Integer> readerFieldToValIds, Set<ReaderField> valMismatchKeys) {
    ...
    public final static class InsanityType {
         ...
         */
        public final static InsanityType SUBREADER = new InsanityType("SUBREADER");
         ...
         * </p>
         */
        public final static InsanityType VALUEMISMATCH = new InsanityType("VALUEMISMATCH");
