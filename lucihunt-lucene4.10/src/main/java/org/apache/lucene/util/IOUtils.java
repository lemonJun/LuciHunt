...
public final class IOUtils {
    ...
    public static void fsync(File fileToSync, boolean isDir) throws IOException {
        ...
        if (isDir) {
            ...
            assert (Constants.LINUX || Constants.MAC_OS_X) == false || Constants.JRE_IS_MINIMUM_JAVA9 : "On Linux and MacOSX fsyncing a directory should not throw IOException, " + "we just don't want to rely on that in production (undocumented). Got: " + exc;
