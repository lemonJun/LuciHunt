...
public final class Constants {
    ...
    @Deprecated
    public static final boolean JRE_IS_MINIMUM_JAVA6 = new Boolean(true).booleanValue(); // prevent inlining in foreign class files

    /** @deprecated With Lucene 4.8, we are always on Java 7 */
    @Deprecated
    public static final boolean JRE_IS_MINIMUM_JAVA7 = new Boolean(true).booleanValue(); // prevent inlining in foreign class files
