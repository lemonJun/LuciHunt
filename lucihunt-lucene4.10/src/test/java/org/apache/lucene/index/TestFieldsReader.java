...
public class TestFieldsReader extends LuceneTestCase {
    ...
    public static void beforeClass() throws Exception {
        ...
        dir = newDirectory();
        IndexWriterConfig conf = newIndexWriterConfig(new MockAnalyzer(random())).setMergePolicy(newLogMergePolicy());
    ...
    public void testExceptions() throws Throwable {
        ...
        try {
            ...
            IndexWriterConfig iwc = newIndexWriterConfig(new MockAnalyzer(random())).setOpenMode(OpenMode.CREATE);
