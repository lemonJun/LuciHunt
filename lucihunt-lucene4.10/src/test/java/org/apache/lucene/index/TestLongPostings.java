...
public class TestLongPostings extends LuceneTestCase {
    ...
    public void testLongPostings() throws Exception {
        ...
        final IndexReader r;
        final IndexWriterConfig iwc = newIndexWriterConfig(new MockAnalyzer(random())).setOpenMode(IndexWriterConfig.OpenMode.CREATE).setMergePolicy(newLogMergePolicy());
