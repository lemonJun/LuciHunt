...
public class TestConcurrentMergeScheduler extends LuceneTestCase {
    ...
    public void testFlushExceptions() throws IOException {
        ...
        IndexWriter writer = new IndexWriter(directory, newIndexWriterConfig(new MockAnalyzer(random())).setMaxBufferedDocs(2));
    ...
    public void testDeleteMerging() throws IOException {
        ...
        IndexWriter writer = new IndexWriter(directory, newIndexWriterConfig(new MockAnalyzer(random())).setMergePolicy(mp));
    ...
    public void testNoExtraFiles() throws IOException {
        ...
        for (int iter = 0; iter < 7; iter++) {
            ...
            // Reopen
            writer = new IndexWriter(directory, newIndexWriterConfig(new MockAnalyzer(random())).setOpenMode(OpenMode.APPEND).setMaxBufferedDocs(2));
        }
    ...
    public void testNoWaitClose() throws IOException {
        ...
        IndexWriter writer = new IndexWriter(directory, newIndexWriterConfig(new MockAnalyzer(random())).setMaxBufferedDocs(2).setMergePolicy(newLogMergePolicy(100)));
        ...
        for (int iter = 0; iter < 10; iter++) {
            ...
            // Reopen
            writer = new IndexWriter(directory, newIndexWriterConfig(new MockAnalyzer(random())).setOpenMode(OpenMode.APPEND).setMergePolicy(newLogMergePolicy(100)));
        }
        writer.close();
