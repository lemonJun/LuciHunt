...
public class TestFilterAtomicReader extends LuceneTestCase {
    ...
    private static void checkOverrideMethods(Class<?> clazz) throws NoSuchMethodException, SecurityException {
        ...
        for (Method m : superClazz.getMethods()) {
            ...
            if (Modifier.isStatic(mods) || Modifier.isAbstract(mods) || Modifier.isFinal(mods) || m.isSynthetic() || m.getName().equals("attributes")) {
                continue;
            }
            ...
            if (subM.getDeclaringClass() == clazz && m.getDeclaringClass() != Object.class && m.getDeclaringClass() != subM.getDeclaringClass()) {
