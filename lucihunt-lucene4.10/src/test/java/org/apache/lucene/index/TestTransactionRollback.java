...
public class TestTransactionRollback extends LuceneTestCase {
    ...
    */
    ...
    public void setUp() throws Exception {
        ...
        IndexWriter w = new IndexWriter(dir, newIndexWriterConfig(new MockAnalyzer(random())).setIndexDeletionPolicy(sdp));
    ...
    public void testRollbackDeletionPolicy() throws Exception {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            // should not work:
            new IndexWriter(dir, newIndexWriterConfig(new MockAnalyzer(random())).setIndexDeletionPolicy(new DeleteLastCommitPolicy())).close();
            IndexReader r = DirectoryReader.open(dir);
