...
public class TestBackwardsCompatibility3x extends LuceneTestCase {
    ...
    */
    final static String[] oldNames = { "30.cfs", "30.nocfs", "301.cfs", "301.nocfs", "302.cfs", "302.nocfs", "303.cfs", "303.nocfs", "31.cfs", "31.nocfs", "32.cfs", "32.nocfs", "33.cfs", "33.nocfs", "34.cfs", "34.nocfs", "35.cfs", "35.nocfs", "36.cfs", "36.nocfs", "361.cfs", "361.nocfs", "362.cfs", "362.nocfs" };

    final String[] unsupportedNames = { "19.cfs", "19.nocfs", "20.cfs", "20.nocfs", "21.cfs", "21.nocfs", "22.cfs", "22.nocfs", "23.cfs", "23.nocfs", "24.cfs", "24.nocfs", "241.cfs", "241.nocfs", "29.cfs", "29.nocfs", "291.cfs", "291.nocfs", "292.cfs", "292.nocfs", "293.cfs", "293.nocfs", "294.cfs", "294.nocfs" };

    final static String[] oldSingleSegmentNames = { "31.optimized.cfs", "31.optimized.nocfs", };
    ...
    public void testOldVersions() throws Exception {
        ...
        for (String name : oldNames) {
            ...
            for (AtomicReaderContext context : r.leaves()) {
                ...
                assertTrue("current Constants.LUCENE_MAIN_VERSION is <= an old index: did you forget to bump it?!", oldVersion == null || currentVersion.onOrAfter(oldVersion));
            }
            r.close();
        }
    }
    ...
    public void testUpgradeOldIndex() throws Exception {
        ...
        for (String name : names) {
            ...
            new IndexUpgrader(dir, newIndexWriterConfig(null), false).upgrade();
