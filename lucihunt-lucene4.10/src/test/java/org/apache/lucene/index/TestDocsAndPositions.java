...
public class TestDocsAndPositions extends LuceneTestCase {
    ...
    public DocsAndPositionsEnum getDocsAndPositions(AtomicReader reader, BytesRef bytes, Bits liveDocs) throws IOException {
            ...
            for (AtomicReaderContext atomicReaderContext : topReaderContext.leaves()) {
                ...
                do {
                    ...
                    for (int j = 0; j < howMany; j++) {
                        assertEquals("iteration: " + i + " initDoc: " + initDoc + " doc: " + docID + " base: " + atomicReaderContext.docBase + " positions: " + Arrays.toString(pos) /* TODO: + " usePayloads: "
