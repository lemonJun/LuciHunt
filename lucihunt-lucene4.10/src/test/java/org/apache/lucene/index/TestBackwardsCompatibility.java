...
public class TestBackwardsCompatibility extends LuceneTestCase {
    ...
    */
    ...
    final static String[] oldNames = { "40a.cfs", "40a.nocfs", "40b.cfs", "40b.nocfs", "40.cfs", "40.nocfs", "41.cfs", "41.nocfs", "42.cfs", "42.nocfs", "421.cfs", "421.nocfs", "43.cfs", "43.nocfs", "431.cfs", "431.nocfs", "44.cfs", "44.nocfs", "45.cfs", "45.nocfs", "451.cfs", "451.nocfs", "46.cfs", "46.nocfs", "461.cfs", "461.nocfs", "47.cfs", "47.nocfs", "471.cfs", "471.nocfs", "472.cfs", "472.nocfs", "48.cfs", "48.nocfs", "481.cfs", "481.nocfs", "49.cfs", "49.nocfs", "491.cfs", "491.nocfs", "410.cfs", "410.nocfs", "4101.cfs", "4101.nocfs", "4102.cfs", "4102.nocfs", "4103.cfs", "4103.nocfs", };

    final String[] unsupportedNames = { "19.cfs", "19.nocfs", "20.cfs", "20.nocfs", "21.cfs", "21.nocfs", "22.cfs", "22.nocfs", "23.cfs", "23.nocfs", "24.cfs", "24.nocfs", "29.cfs", "29.nocfs", };

    final static String[] oldSingleSegmentNames = { "40a.optimized.cfs", "40a.optimized.nocfs", };
        ...
        for (java.lang.reflect.Field field : Version.class.getDeclaredFields()) {
            if (Modifier.isStatic(field.getModifiers()) && field.getType() == Version.class) {
                ...
                if (v.equals(Version.LATEST))
                    continue;
                if (v.major == 3)
                    continue; // 3x codecs are tested in TestBackwardsCompatilibility3x
    ...
    public File createIndex(String dirName, boolean doCFS, boolean fullyMerged) throws IOException {
        ...
        if (!fullyMerged) {
            ...
            conf = new IndexWriterConfig(TEST_VERSION_CURRENT, new MockAnalyzer(random())).setUseCompoundFile(doCFS).setMaxBufferedDocs(10).setMergePolicy(NoMergePolicy.INSTANCE);
            writer = new IndexWriter(dir, conf);
