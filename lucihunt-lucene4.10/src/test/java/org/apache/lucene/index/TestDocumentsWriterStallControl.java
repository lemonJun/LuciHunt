...
public class TestDocumentsWriterStallControl extends LuceneTestCase {
    ...
    public static class Waiter extends Thread {
        ...
        public Waiter(AtomicBoolean stop, AtomicBoolean checkPoint, DocumentsWriterStallControl ctrl, Synchronizer sync, List<Throwable> exceptions) {
            super("waiter");
            this.stop = stop;
    ...
    public static class Updater extends Thread {
        ...
        public Updater(AtomicBoolean stop, AtomicBoolean checkPoint, DocumentsWriterStallControl ctrl, Synchronizer sync, boolean release, List<Throwable> exceptions) {
            super("updater");
            this.stop = stop;
            this.checkPoint = checkPoint;
            this.ctrl = ctrl;
