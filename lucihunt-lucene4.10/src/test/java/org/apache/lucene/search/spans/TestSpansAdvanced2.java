...
public class TestSpansAdvanced2 extends TestSpansAdvanced {
    ...
    public void setUp() throws Exception {
        ...
        // create test index
        final RandomIndexWriter writer = new RandomIndexWriter(random(), mDirectory, newIndexWriterConfig(new MockAnalyzer(random(), MockTokenizer.SIMPLE, true, MockTokenFilter.ENGLISH_STOPSET)).setOpenMode(OpenMode.APPEND).setMergePolicy(newLogMergePolicy()).setSimilarity(new DefaultSimilarity()));
    ...
    public void testSingleSpanQuery() throws IOException {
        ...
        final float[] expectedScores = new float[] { 0.625f, 0.45927936f, 0.35355338f, 0.35355338f, 0.35355338f, 0.35355338f, 0.26516503f, };
