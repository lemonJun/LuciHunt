...
public class TestNearSpansOrdered extends LuceneTestCase {
    ...
    protected String[] docFields = { "w1 w2 w3 w4 w5", "w1 w3 w2 w3 zz", "w1 xx w2 yy w3", "w1 w3 xx w2 yy w3 zz" };
    ...
    protected SpanNearQuery makeOverlappedQuery(String sqt1, String sqt2, boolean sqOrdered, String t3, boolean ordered) {
        return new SpanNearQuery(new SpanQuery[] { new SpanNearQuery(new SpanQuery[] { new SpanTermQuery(new Term(FIELD, sqt1)), new SpanTermQuery(new Term(FIELD, sqt2)) }, 1, sqOrdered), new SpanTermQuery(new Term(FIELD, t3)) }, 0, ordered);
    }
    ...
    public void testSpanNearScorerExplain() throws Exception {
        ...
        assertTrue("Scorer explanation value for doc#1 isn't positive: " + e.toString(), 0.0f < e.getValue());
    }
}
