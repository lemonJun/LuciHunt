...
public class TestDisjunctionMaxQuery extends LuceneTestCase {
    ...
    public void setUp() throws Exception {
        ...
        index = newDirectory();
        RandomIndexWriter writer = new RandomIndexWriter(random(), index, newIndexWriterConfig(new MockAnalyzer(random())).setSimilarity(sim).setMergePolicy(newLogMergePolicy()));
