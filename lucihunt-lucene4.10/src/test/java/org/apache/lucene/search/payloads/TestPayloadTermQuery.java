...
public class TestPayloadTermQuery extends LuceneTestCase {
    ...
    public static void beforeClass() throws Exception {
        ...
        RandomIndexWriter writer = new RandomIndexWriter(random(), directory, newIndexWriterConfig(new PayloadAnalyzer()).setSimilarity(similarity).setMergePolicy(newLogMergePolicy()));
