...
public class TestElevationComparator extends LuceneTestCase {
    ...
    public void testSorting() throws Throwable {
        ...
        IndexWriter writer = new IndexWriter(directory, newIndexWriterConfig(new MockAnalyzer(random())).setMaxBufferedDocs(2).setMergePolicy(newLogMergePolicy(1000)).setSimilarity(new DefaultSimilarity()));
