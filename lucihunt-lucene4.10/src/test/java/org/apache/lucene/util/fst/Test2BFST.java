    ...
    public void test() throws Exception {
        ...
        for (int doPackIter = 0; doPackIter < 2; doPackIter++) {
            ...
            if (!doPack) {
                ...
                final Builder<Object> b = new Builder<>(FST.INPUT_TYPE.BYTE1, 0, 0, true, true, Integer.MAX_VALUE, outputs, doPack, PackedInts.COMPACT, true, 15);
            ...
            // size = 3GB
            {
                ...
                final Builder<BytesRef> b = new Builder<>(FST.INPUT_TYPE.BYTE1, 0, 0, true, true, Integer.MAX_VALUE, outputs, doPack, PackedInts.COMPACT, true, 15);
            ...
            // size = 3GB
            {
                ...
                final Builder<Long> b = new Builder<>(FST.INPUT_TYPE.BYTE1, 0, 0, true, true, Integer.MAX_VALUE, outputs, doPack, PackedInts.COMPACT, true, 15);
