...
public abstract class WithNestedTests {
    ...
    public static abstract class AbstractNestedTest extends LuceneTestCase implements TestRuleIgnoreTestSuites.NestedTestSuite {
    ...
    protected void assertFailureCount(int expected, Result result) {
        if (result.getFailureCount() != expected) {
            ...
            RandomizedTest.assertFalse("Expected failures: " + expected + " but was " + result.getFailureCount() + ", failures below: " + b.toString(), true);
        }
    }
