...
public class TestBroadWord extends LuceneTestCase {
    ...
    public void testSmalleru_87_01() {
        ...
        for (long i = 0x0L; i <= 0x7FL; i++) {
            for (long j = 0x0L; i <= 0x7FL; i++) {
                ...
                assertEquals(ToStringUtils.longHex(ii) + " < " + ToStringUtils.longHex(jj), ToStringUtils.longHex((i < j) ? (0x80L * BroadWord.L8_L) : 0x0L), ToStringUtils.longHex(BroadWord.smallerUpTo7_8(ii, jj)));
            }
        }
    }
    ...
    public void testSmalleru_8_01() {
        ...
        for (long i = 0x0L; i <= 0xFFL; i++) {
            for (long j = 0x0L; i <= 0xFFL; i++) {
                long ii = i * BroadWord.L8_L;
                long jj = j * BroadWord.L8_L;
                assertEquals(ToStringUtils.longHex(ii) + " < " + ToStringUtils.longHex(jj), ToStringUtils.longHex((i < j) ? (0x80L * BroadWord.L8_L) : 0x0L), ToStringUtils.longHex(BroadWord.smalleru_8(ii, jj)));
            }
        }
    }
    ...
    public void testNotEquals0_8() {
        ...
        for (long i = 0x0L; i <= 0xFFL; i++) {
            long ii = i * BroadWord.L8_L;
            assertEquals(ToStringUtils.longHex(ii) + " <> 0", ToStringUtils.longHex((i != 0L) ? (0x80L * BroadWord.L8_L) : 0x0L), ToStringUtils.longHex(BroadWord.notEquals0_8(ii)));
        }
    }
}
