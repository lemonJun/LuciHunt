...
public class TestVersion extends LuceneTestCase {
    ...
    public void testLatestVersionCommonBuild() {
        ...
        assumeTrue("Null 'tests.LUCENE_VERSION' test property. You should run the tests with the official Lucene build file", commonBuildVersion != null);
        assertEquals("Version.LATEST does not match the one given in common-build.xml", Version.LATEST.toString(), commonBuildVersion);
    }
